...
import { Paper, TextField, Grid, Button, Typography, Divider, InputAdornment } from '@material-ui/core';
  ...
  render() {
    return (
      <Grid item md={12}>
        <form>
          <Paper elevation={1}>
            <Grid container item direction="column" className="paper-container" spacing={8}>
